...
-- *NEVER* TOUCH THE LEADING WHITESPACES!
    require("_wow")
...
require("modules.spell.spells_healer")
...
require("modules.unit.unit_timetodie")
...
require("modules.player.player_target_orientation")
require("modules.auto_turn")
require("modules.totem")
require("modules.spell_id")
require("modules.unlock.basic")
require("rotations.deathknight_spells")
require("rotations.demonhunter_spells")
require("rotations.druid_spells")
require("rotations.hunter_spells")
require("rotations.mage_spells")
require("rotations.monk_spells")
require("rotations.paladin_spells")
require("rotations.priest_spells")
require("rotations.rogue_spells")
require("rotations.shaman_spells")
require("rotations.warlock_spells")
require("rotations.warrior_spells")
require("rotations.evoker_spells")
require("rotations.deathknight")
require("rotations.demonhunter")
...
require("rotations.monk_mistweaver")
require("rotations.monk_windwalker")
require("rotations.paladin_holy")
...
require("rotations.shaman_elemental")
require("rotations.shaman_enhancement")
require("rotations.shaman_restoration")
