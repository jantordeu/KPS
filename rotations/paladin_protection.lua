...
kps.rotations.register("PALADIN","PROTECTION",
{
    ...
    {spells.handOfTheProtector, 'player.hasTalent(5,3) and player.hp < 0.85 and not player.hasBuff(spells.shieldOfTheRighteous)' },
    {spells.lightOfTheProtector, 'not player.hasTalent(5,3) and player.hp < 0.85 and not player.hasBuff(spells.shieldOfTheRighteous)' },
    ...
    {spells.guardianOfAncientKings, 'player.hp < 0.55 and not player.hasBuff(spells.shieldOfTheRighteous) and not player.hasBuff(spells.ardentDefender)' },
    ...
    {spells.shieldOfTheRighteous, 'not player.hasBuff(spells.shieldOfTheRighteous) and player.incomingDamage > player.incomingHeal' , "target" , "shieldOfTheRighteous_incomingDamage"},
    ...
    {spells.avengersShield, 'target.distance <= 10 and target.distance <= 10 and not target.hasMyDebuff(spells.avengersShield)' , "target" , "avengersShield" },
