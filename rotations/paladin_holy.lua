...
kps.rotations.register("PALADIN","HOLY",
{
    ...
    {spells.holyLight, 'not player.isMoving and heal.lowestUnitInRaid.hpIncoming < 0.85 and heal.lowestUnitInRaid.hpIncoming < heal.lowestTankInRaid.hpIncoming' , kps.heal.lowestUnitInRaid , "heal_lowest" },
