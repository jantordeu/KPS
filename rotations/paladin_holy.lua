...
kps.rotations.register("PALADIN","HOLY",
{
    ...
    {spells.beaconOfLight, 'not player.hasTalent(7,3) and focus.isHealable and not focus.hasBuff(spells.beaconOfLight) and not focus.isUnit("player")' , "focus" },
    ...
    {spells.holyPrism, 'player.hasTalent(5,2) and heal.countLossInRange(0.80) > 2 and target.isAttackable and targettarget.isFriend and targettarget.hp < 0.90' , "targettarget" },
