...
-- ERROR in 'battle_cry,sync=colossus_smash': Spell 'battleCry' unknown!
-- ERROR in 'battle_cry,if=debuff.colossus_smash.remains>=5|(debuff.colossus_smash.up&cooldown.colossus_smash.remains=0)': Spell 'battleCry' unknown!
...
-- ERROR in 'mortal_strike,if=buff.shattered_defenses.up&buff.focused_rage.stack=3': Spell 'kps.spells.warrior.focusedRage' unknown (in expression: 'buff.focused_rage.stack')!
