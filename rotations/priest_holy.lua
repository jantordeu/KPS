...
kps.runAtEnd(function()
   kps.gui.addCustomToggle("PRIEST","HOLY", "mindControl ", "Interface\\Icons\\spell_nature_polymorph", "mindControl ")
end)
...
kps.rotations.register("PRIEST","HOLY",{
    ...
    {{"macro"}, 'mouseover.isHealable and mouseover.isRaidTank and mouseover.hp < 0.65', "/cast [@cursor] "..HolyWordSanctify },
    ...
    {{"nested"}, 'player.isMoving' ,{
        ...
        {spells.renew, 'player.hpIncoming < 1 and not player.hasBuff(spells.renew)' , "player" },
