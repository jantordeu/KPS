...
kps.rotations.register("PRIEST","HOLY",{
    ...
    {{"macro"}, 'kps.defensive and spells.flashHeal.shouldInterrupt(0.90,true)' , "/stopcasting" },
    ...
    -- "Soins"
    {spells.heal, 'mouseover.isHealable and mouseover.hpIncoming < 0.92' , "mouseover" ,"heal_mouseover" },
