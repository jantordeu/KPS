...
kps.rotations.register("PRIEST","SHADOW",
{
    ...
    {spells.voidEruption, 'not player.isMoving and not player.hasBuff(spells.voidForm) and player.insanity > 40' , env.damageTarget , "voidEruption"  },
    ...
    {spells.devouringPlague, 'not kps.mindSear and target.isAttackable' , env.damageTarget },
