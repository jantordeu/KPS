...
kps.rotations.register("PRIEST","SHADOW",
{
    ...
    {spells.powerInfusion, 'kps.multiTarget and player.insanity >= 40' },
    {spells.shadowfiend, 'player.hasBuff(spells.voidForm)' , env.damageTarget },
    {spells.voidEruption, 'kps.multiTarget and not player.isMoving and not player.hasBuff(spells.voidForm) and player.insanity >= 40' , env.damageTarget , "voidEruption"  },
