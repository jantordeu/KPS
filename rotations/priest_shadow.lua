...
kps.rotations.register("PRIEST","SHADOW",{
    ...
    {spells.azerite.concentratedFlame, 'not player.hasBuff(spells.voidForm) and target.isAttackable' , env.damageTarget },
    ...
    {spells.mindBlast, 'not player.isMoving and not player.hasBuff(spells.voidForm)' , env.damageTarget },
