...
kps.rotations.register("PRIEST","SHADOW",
{
    ...
    {spells.shadowWordDeath, 'IsEquippedItem(173244) and spells.shadowfiend.lastCasted(15) and player.hp > 0.70' , env.damageTarget },
    ...
    {spells.powerInfusion, 'kps.multiTarget and not player.isMoving and not player.hasBuff(spells.voidForm) and spells.voidEruption.cooldown > 19' },
    ...
    {spells.mindBlast, 'IsEquippedItem(173244) and not player.isMoving and player.hasBuff(spells.voidForm)' , env.damageTarget },
    ...
    {spells.devouringPlague, 'player.isMoving and target.isAttackable' , "target" },
    ...
    {spells.mindBlast, 'not player.isMoving and player.hasBuff(spells.voidForm)' , env.damageTarget , 'mindBlast_darkThoughts' },
