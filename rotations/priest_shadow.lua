...
kps.rotations.register("PRIEST","SHADOW",
{
    ...
    {spells.powerInfusion, 'kps.multiTarget and not player.isMoving and spells.voidEruption.cooldown > 10' },
    ...
    {spells.voidEruption, 'kps.multiTarget and not player.isMoving and not player.hasBuff(spells.voidForm)' , env.damageTarget , "voidEruption"  },    
