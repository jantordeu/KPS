...
kps.rotations.register("PRIEST","SHADOW",
{
    ...
    {spells.vampiricTouch, 'not player.isMoving and player.hasTalent(3,2) and mouseover.inCombat and mouseover.isAttackable and mouseover.myDebuffDuration(spells.shadowWordPain) < 4 and not spells.vampiricTouch.isRecastAt("mouseover")' , "mouseover" , "misere" },
    {spells.shadowWordPain, 'not player.hasTalent(3,2) and mouseover.inCombat and mouseover.isAttackable and mouseover.myDebuffDuration(spells.shadowWordPain) < 4' , "mouseover" },
    {spells.shadowWordPain, 'player.isMoving and mouseover.inCombat and mouseover.isAttackable and mouseover.myDebuffDuration(spells.shadowWordPain) < 4' , "mouseover" },
    ...
    {spells.mindBlast, 'player.hasBuff(spells.darkThoughts) and player.hasBuff(spells.talbadarStratagem)' , env.damageTarget , 'mindBlast_darkThoughts_talbadar' },
    ...
    {spells.voidEruption, 'not player.hasBuff(spells.voidForm) and player.hasBuff(spells.dissonantEchoes)' , env.damageTarget , "voidEruption_dissonantEchoes"  },
    ...
    {spells.vampiricTouch, 'not player.isMoving and player.hasTalent(3,2) and target.isAttackable and target.myDebuffDuration(spells.shadowWordPain) < 4 and not spells.vampiricTouch.isRecastAt("target")' , "target" , "misere" },
    {spells.shadowWordPain, 'not player.hasTalent(3,2) and target.isAttackable and target.myDebuffDuration(spells.shadowWordPain) < 4' , "target" },
    {spells.shadowWordPain, 'player.isMoving and target.isAttackable and target.myDebuffDuration(spells.shadowWordPain) < 4' , "target" },
