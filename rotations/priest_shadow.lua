...
kps.rotations.register("PRIEST","SHADOW",
{
    ...
    {spells.mindBlast, 'player.hasBuff(spells.darkThoughts)' , env.damageTarget , 'mindBlast_darkThoughts_talbadar' },
    ...
    {spells.shadowWordPain, 'not player.hasTalent(3,2) and mouseover.inCombat and mouseover.isAttackable and mouseover.myDebuffDuration(spells.shadowWordPain) < 5' , "mouseover" },
    {spells.shadowWordPain, 'player.isMoving and mouseover.inCombat and mouseover.isAttackable and mouseover.myDebuffDuration(spells.shadowWordPain) < 5' , "mouseover" },
    ...
    {spells.shadowWordPain, 'not player.hasTalent(3,2) and target.isAttackable and target.myDebuffDuration(spells.shadowWordPain) < 5' , "target" },
    {spells.shadowWordPain, 'player.isMoving and target.isAttackable and target.myDebuffDuration(spells.shadowWordPain) < 5' , "target" },
    {spells.devouringPlague, 'target.isAttackable' , env.damageTarget },
