...
kps.rotations.register("PRIEST","DISCIPLINE",{
    ...
    -- RADIANCE
    {spells.powerWordRadiance, 'not player.isMoving and mouseover.isHealable and heal.hasNotBuffAtonementCount(0.80) > 2 and not spells.powerWordRadiance.isRecastAt("mouseover")' , "mouseover" , "radiance_mouseover" },  
    ...
    {{"nested"}, 'kps.multiTarget' , {
        {spells.powerWordRadiance, 'not player.isMoving and not heal.lowestTankInRaid.hasMyBuff(spells.atonement) and not heal.lowestTankInRaid.isUnit("player") and not spells.powerWordRadiance.isRecastAt(heal.lowestTankInRaid.unit)' , kps.heal.lowestTankInRaid , "radiance_tank" },
        {spells.powerWordRadiance, 'not player.isMoving and not player.hasMyBuff(spells.atonement) and not spells.powerWordRadiance.isRecastAt("player")' , "player" , "radiance_player" },
        {spells.powerWordRadiance, 'not player.isMoving and not heal.hasNotBuffAtonement.isUnit("player") and not spells.powerWordRadiance.isRecastAt("heal.hasNotBuffAtonement.unit")' , kps.heal.hasNotBuffAtonement , "radiance_hasNotBuffAtonement" },
    }},
    {{"nested"}, 'spells.powerWordRadiance.lastCasted(9)' , {
        {spells.evangelism, 'heal.hasBuffCount(spells.atonement) > 4 and spells.powerWordRadiance.charges == 0' },
        {spells.schism, 'not player.isMoving' , env.damageTarget , "hasBuffAtonementCount" },
    ...
    {{"nested"}, 'kps.defensive' , {
        ...
        {spells.shadowMend, 'not player.isMoving and targettarget.isFriend and targettarget.hp < 0.40' , "targettarget" , "shadowMend_targettarget" },
...
--        {spells.schism, 'not player.isMoving and heal.hasBuffAtonementCount(0.80) >= 1' , env.damageTarget , "overchargeMana" },
...
--        {spells.penance, 'heal.hasBuffAtonementCount(0.90) >= 1' , env.damageTarget , "overchargeMana" },
