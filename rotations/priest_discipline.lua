...
kps.rotations.register("PRIEST","DISCIPLINE",{
    ...
    {{"nested"}, 'kps.multiTarget' , {
        {spells.powerWordRadiance, 'not player.isMoving and mouseover.isHealable and heal.hasNotBuffAtonementCount(0.85) >= 3 and not spells.powerWordRadiance.isRecastAt("mouseover")' , "mouseover" , "radiance_mouseover" },  
        ...
        {spells.evangelism, 'spells.powerWordRadiance.lastCasted(7) and heal.hasBuffAtonementCount(0.85) >= 5' },
        {spells.mindbender, 'player.hasTalent(3,2) and spells.evangelism.lastCasted(9)' , env.damageTarget },
        {spells.shadowfiend, 'not player.hasTalent(3,2) and spells.evangelism.lastCasted(9)' , env.damageTarget }, 
        {spells.schism, 'not player.isMoving and spells.powerWordRadiance.lastCasted(9) and heal.hasBuffAtonementCount(0.85) >= 1' , env.damageTarget , "hasBuffAtonementCount" },
        {spells.penance, 'spells.powerWordRadiance.lastCasted(9) and heal.hasBuffAtonementCount(0.85) >= 1' , env.damageTarget , "hasBuffAtonementCount" },
        {spells.powerWordSolace, 'spells.powerWordRadiance.lastCasted(9)' , env.damageTarget  , "hasBuffAtonementCount" },
    }},
    -- RAPTURE MANUAL
    ...
    {spells.divineStar, 'player.hasTalent(6,2) and heal.countLossInRange(0.85) >= 3 and target.distance <= 20' , "target" },
    ...
    {spells.luminousBarrier, 'player.hasTalent(7,2) and heal.countLossInRange(0.85) >= 3' },
    {spells.luminousBarrier, 'player.hasTalent(7,2) and not player.isInGroup and player.hp < 0.65' },
    ...
    {{"nested"}, 'kps.defensive' , {
        ...
        {spells.shadowMend, 'not player.isMoving and targettarget.isFriend and targettarget.hp < 0.65 and not spells.shadowMend.isRecastAt("targettarget")' , "targettarget" , "shadowMend_targettarget" },
...
--    }},
    ...
    {spells.penance, 'heal.hasBuffAtonementCount(0.90) >= 1' , env.damageTarget , "hasBuffAtonementCount" },
    {spells.powerWordSolace, 'heal.hasBuffAtonementCount(0.90) >= 1' , env.damageTarget  , "hasBuffAtonementCount" },
    {spells.smite, 'not player.isMoving and heal.hasNotBuffAtonementCount(0.80) == 0' , env.damageTarget , "hasNotBuffAtonementCount" },

    {spells.shadowMend, 'mouseover.isHealable and not player.isMoving and mouseover.hp < 0.80 and not mouseover.hasMyBuff(spells.atonement) and not spells.shadowMend.isRecastAt("mouseover")' , "mouseover" , "shadowMend_mouseover"},
    {spells.shadowMend, 'mouseover.isHealable and not player.isMoving and mouseover.hp < 0.40' , "mouseover" , "shadowMend_mouseover_lowhp"},
    {spells.powerWordShield, 'mouseover.isHealable and not mouseover.hasMyBuff(spells.atonement) and mouseover.hp < 0.90 and not mouseover.hasDebuff(spells.weakenedSoul)' , "mouseover" , "powerWordShield_mouseover" },
    {spells.powerWordShield, 'mouseover.isHealable and mouseover.hp < 0.40 and not mouseover.hasDebuff(spells.weakenedSoul)' , "mouseover" , "powerWordShield_mouseover_lowhp" },
