...
kps.rotations.register("PRIEST","DISCIPLINE",{
    ...
    -- ASSISTTANK
    {spells.shadowMend, 'not player.isMoving and not heal.assistTankInRaid.isUnit("player") and not heal.assistTankInRaid.hasMyBuff(spells.atonement) and not spells.shadowMend.isRecastAt(heal.assistTankInRaid.unit) and not spells.powerWordRadiance.isRecastAt(heal.assistTankInRaid.unit)' , kps.heal.assistTankInRaid , "shadowMend_assistTank" },
    {spells.powerWordShield, 'not heal.assistTankInRaid.isUnit("player") and not heal.assistTankInRaid.hasMyBuff(spells.atonement) and not spells.shadowMend.isRecastAt(heal.assistTankInRaid.unit) and not spells.powerWordRadiance.isRecastAt(heal.assistTankInRaid.unit) and not heal.assistTankInRaid.hasDebuff(spells.weakenedSoul)' , kps.heal.assistTankInRaid , "powerWordShield_assistTank" },
    {spells.penance, 'heal.assistTankInRaid.myBuffDuration(spells.atonement) > 2 and not heal.assistTankInRaid.isUnit("player") and heal.assistTankInRaid.hp < 0.40' , kps.heal.assistTankInRaid  , "penance_defensive_assistTank" },
