...
kps.rotations.register("PRIEST","DISCIPLINE",{
    ...
    {spells.rapture, 'heal.hasNotBuffAtonementCount(0.85) >= 3 and spells.powerWordRadiance.charges == 0 and spells.powerWordRadiance.cooldown > 7 and spells.penance.cooldown > 4 and spells.schism.cooldown > 4' },
    
    {{"nested"}, 'kps.multiTarget and player.hasBuff(spells.overchargeMana) and spells.overchargeMana.cooldown < 23' , {
    ...
    {{"nested"}, 'kps.multiTarget and player.hasBuff(spells.overchargeMana) and spells.overchargeMana.cooldown > 23' , {
        {spells.powerWordShield, 'not heal.lowestTankInRaid.isUnit("player") and heal.lowestTankInRaid.myBuffDuration(spells.atonement) < 7 and not heal.lowestTankInRaid.hasDebuff(spells.weakenedSoul)' , kps.heal.lowestTankInRaid , "powerWordShield_tank_multiTarget" },
        {spells.powerWordShield, 'player.myBuffDuration(spells.atonement) < 7 and not player.hasDebuff(spells.weakenedSoul)' , "player" , "powerWordShield_player_multiTarget" },
        {spells.powerWordRadiance, 'not player.isMoving and not heal.lowestTankInRaid.hasMyBuff(spells.atonement) and not spells.powerWordRadiance.isRecastAt(heal.lowestTankInRaid.unit)' , kps.heal.lowestTankInRaid , "radiance_tank_multiTarget" },
        ...
        {spells.powerWordRadiance, 'not player.isMoving and not heal.hasNotBuffAtonement.isUnit("player") and heal.hasNotBuffAtonement.hp < 0.85' , kps.heal.hasNotBuffAtonement , "radiance_hasNotBuffAtonement_multiTarget" },
    ...
    {spells.overchargeMana , 'kps.multiTarget and spells.powerWordRadiance.charges > 0 and spells.schism.cooldown < 7' },
    {spells.overchargeMana, 'heal.hasNotBuffAtonementCount(0.80) >= 3 and spells.powerWordRadiance.charges > 0 and spells.schism.cooldown < 7' },
    -- RADIANCE
    {spells.powerWordRadiance, 'not player.isMoving and heal.hasNotBuffAtonementCount(0.80) >= 3 and not heal.lowestTankInRaid.hasMyBuff(spells.atonement) and not spells.powerWordRadiance.isRecastAt(heal.lowestTankInRaid.unit)' , kps.heal.lowestTankInRaid , "radiance_tank" },
    {spells.powerWordRadiance, 'not player.isMoving and heal.hasNotBuffAtonementCount(0.80) >= 3 and not player.hasMyBuff(spells.atonement) and not spells.powerWordRadiance.isRecastAt("player")' , "player" , "radiance_player" },
    ...
    {spells.evangelism, 'heal.hasBuffAtonementCount(0.80) >= 3 and spells.powerWordRadiance.lastCasted(7)' },
    ...
    {{"nested"}, 'kps.defensive' , {
        ...
        {spells.schism, 'not player.isMoving and not player.isInGroup and spells.powerWordSolace.cooldown < 7' , env.damageTarget },
        {spells.schism, 'not player.isMoving and not player.isInGroup and spells.penance.cooldown < 7' , env.damageTarget },
    ...
    {{"nested"}, 'not kps.multiTarget' , {
    	...
    	{spells.shadowMend, 'not player.isMoving and heal.hasNotBuffAtonementCount(0.80) >= 1 and not heal.hasNotBuffAtonement.isUnit("player") and not spells.shadowMend.isRecastAt(heal.hasNotBuffAtonement.unit)' , kps.heal.hasNotBuffAtonement , "shadowMend_hasNotBuffAtonement" },
    	{spells.powerWordShield, 'heal.hasNotBuffAtonementCount(0.80) >= 1 and not heal.hasNotBuffAtonement.hasDebuff(spells.weakenedSoul) and not heal.hasNotBuffAtonement.isUnit("player")' , kps.heal.hasNotBuffAtonement , "powerWordShield_hasNotBuffAtonement" },
    }},
    {spells.powerWordSolace, 'true' , env.damageTarget  , "hasBuffAtonementCount" },
    {spells.penance, 'kps.multiTarget and spells.overchargeMana.cooldown < 14' , env.damageTarget , "multiTarget" },

    -- EMERGENCY
    {spells.shadowMend, 'not player.isMoving and player.hp < 0.40' , "player" , "FLASH_PLAYER"  },
    ...
    {spells.powerWordShield, 'mouseovertarget.isHealable and mouseovertarget.hp < 0.90 and not mouseovertarget.hasMyBuff(spells.atonement) and not mouseovertarget.hasDebuff(spells.weakenedSoul)' , "mouseovertarget" , "powerWordShield_mouseovertarget" },
    {spells.schism, 'mouseovertarget.hp < 0.65', "mouseover" , "schism_mouseover"},
    {spells.powerWordSolace, 'true', "mouseover" , "solace_mouseover"},
    {spells.penance, 'mouseovertarget.hp < 0.90', "mouseover" , "penance_offensive_mouseover"},
    ...
    {spells.powerWordShield, 'not mouseover.hasMyBuff(spells.atonement) and mouseover.hp < 0.90 and not mouseover.hasDebuff(spells.weakenedSoul)' , "mouseover" , "powerWordShield_mouseover" },
