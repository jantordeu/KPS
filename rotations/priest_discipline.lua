...
kps.rotations.register("PRIEST","DISCIPLINE",{
    ...
    {{"nested"},'spells.powerWordRadiance.lastCasted(9) and heal.hasBuffAtonement.hp < 0.80', {
        {spells.mindgames, 'not player.isMoving and spells.schism.lastCasted(9)' , env.damageTarget },
        {spells.schism, 'not player.isMoving' , env.damageTarget },
    }},

    -- RADIANCE mini RAMP
    {spells.powerWordShield, 'heal.countLossInRange(0.80) > 4 and heal.lowestTankInRaid.myBuffDuration(spells.atonement) < 9 and not heal.lowestTankInRaid.hasDebuff(spells.weakenedSoul)' , kps.heal.lowestTankInRaid , "shield_tank_rampUp" },
    {spells.powerWordShield, 'heal.countLossInRange(0.80) > 4 and player.hp < 0.80 and player.myBuffDuration(spells.atonement) < 9 and not player.hasDebuff(spells.weakenedSoul)' , "player"  , "shield_player_rampUp" },
    ...
    {spells.mindgames, 'not player.isMoving and spells.schism.lastCasted(9) and heal.lowestTankInRaid.hp < 0.70' , env.damageTarget },
