...
kps.rotations.register("PRIEST","DISCIPLINE",{
    ...
    {{"nested"}, 'heal.hasBuffAtonementCount(0.80) >= 3 and spells.powerWordRadiance.lastCasted(9)' , {
   ...
   -- NOT ISINGROUP
    {{"nested"}, 'kps.multiTarget' , {
        ...
        {spells.schism, 'not player.isMoving and player.hasTalent(1,3) and target.isAttackable and spells.penance.cooldown < 7 and spells.powerWordSolace.cooldown < 7' , "target" },
    ...
    {spells.powerWordSolace, 'mouseovertarget.isAttackable and mouseover.myBuffDuration(spells.atonement) > 2 and mouseover.hp < 1' , "mouseovertarget" , "solace_mouseovertarget" },
    ...
    {spells.penance, 'mouseovertarget.isAttackable and mouseover.myBuffDuration(spells.atonement) > 2 and mouseover.hp < 0.90' , "mouseovertarget" , "penance_offensive_mouseovertarget" },
    ...
    {spells.powerWordSolace, 'mouseovertarget.myBuffDuration(spells.atonement) > 2 and mouseovertarget.hp < 1', "mouseover" , "solace_mouseover"},
    {spells.purgeTheWicked,'mouseover.inCombat and player.hasTalent(6,1) and mouseover.myDebuffDuration(spells.purgeTheWicked) < 4.8 and not spells.purgeTheWicked.isRecastAt("mouseover")', "mouseover" , "pain_mouseover"},
    {spells.shadowWordPain,'mouseover.inCombat and player.hasTalent(6,1) and mouseover.myDebuffDuration(spells.purgeTheWicked) < 4.8 and not spells.purgeTheWicked.isRecastAt("mouseover")', "mouseover" , "pain_mouseover"},
    ...
    {spells.powerWordSolace, 'heal.lossHealthRaidAtonement > 0' , env.damageTarget  , "solace_offensive" },
    ...
    {spells.shadowMend, 'not player.isMoving and heal.hasNotBuffAtonement.hp < 0.65 and not heal.hasNotBuffAtonement.isUnit("player")', kps.heal.hasNotBuffAtonement ,  "shadowMend_lowest" },
    {spells.powerWordShield, 'heal.hasNotBuffAtonement.hp < 0.90 and not heal.hasNotBuffAtonement.isUnit("player") and not heal.hasNotBuffAtonement.hasDebuff(spells.weakenedSoul)', kps.heal.hasNotBuffAtonement ,  "powerWordShield_lowest" },
