...
kps.rotations.register("PRIEST","DISCIPLINE",{
   ...
   {spells.painSuppression, 'player.hp < 0.40' , "player" },
    ...
    {{"nested"}, 'kps.multiTarget' , {
        ...
        {spells.powerWordRadiance, 'kps.mouseOver and mouseover.isFriend and not player.isMoving and heal.hasNotBuffAtonementCount(0.80) > 2' , "mouseover" , "radiance_mouseover"},
        ...
        {spells.powerWordShield, 'kps.mouseOver and mouseover.isFriend and mouseover.myBuffDuration(spells.atonement) < 1 and mouseover.hp < 1 and not mouseover.hasDebuff(spells.weakenedSoul)' , "mouseover" },
