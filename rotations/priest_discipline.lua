...
kps.rotations.register("PRIEST","DISCIPLINE",{
    ...
    {spells.powerWordRadiance, 'not player.isMoving and heal.countLossInRange(0.80) > 2 and mouseover.hp < 0.80 and mouseover.myBuffDuration(spells.atonement) < 2 and not spells.powerWordRadiance.isRecastAt("mouseover")' , "mouseover" , "radiance_mouseover" },
    {{"nested"},'not player.isMoving and heal.countLossInRange(0.80) > 4 and not spells.powerWordRadiance.lastCasted(9)', {
        ...
        {spells.powerWordRadiance, 'heal.countLossInRange(0.80) > 4' , kps.heal.lowestInRaid , "radiance_lowest" },
    }},
    -- MOUSEOVER
